Pod::Spec.new do |spec|
  ...
  spec.screenshots  = "https://raw.githubusercontent.com/ShashikantBhadke/SBDropDown/master/SBDropDown/Screenshot%202019-07-31%20at%209.38.03%20PM.png"
  spec.license      = "MIT"
  spec.license      = { :type => "MIT", :file => "LICENSE" }
  spec.author       = { "Shashikant_B" => "shashibhadke22@gmail.com" }
  spec.platform     = :ios, "10.0"
  spec.source       = { :git => "https://github.com/ShashikantBhadke/SBDropDown.git", :tag => "0.0.1"}
